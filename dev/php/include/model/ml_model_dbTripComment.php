 ...
 * 
 */
class ml_model_dbTripComment extends Lib_datamodel_db 
{
 ...
 */
    ...
    function addComment($act_uid , $dest_uid , $trip_id , $photo_id = 0 , $comment = '')
    {
    ...
    function listCommentByTrip($uid , $trip_id , $photo_id = 0 , $page = 1 , $pagesize = 10)
    {
    ...
    function listCommentCountByTrip($uid , $trip_id , $photo_id = 0)
    {
        if(!$this->init_db($uid , self::DB_SLAVE))
            return false;
        $photo_where = $photo_id > 0 ? ' AND photo_id = '.$photo_id : '';
