...
@property (retain , nonatomic) modelMyTrip *modelMyTrip;
...
- (void)save
{
    if([self isAllInputAvailable])
    {
        ...
        BOOL rs = [self.modelMyTrip addTripNamed:self.tripTitle.text who:[userModel getUid] startAt:self.tripDate.text forDays:[self.tripDays.text intValue] toDestination:tripWhere.text];
    }
}
- (BOOL)isAllInputAvailable
{
